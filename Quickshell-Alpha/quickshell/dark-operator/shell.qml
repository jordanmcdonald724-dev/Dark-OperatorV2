...
ShellRoot {
    ...
    function gotoStation(n) {
        // hyprctl is used here deliberately: it is stable with the user's current Lua-mode Hyprland.
    ...
    // TOP OPERATOR ISLAND: deliberate, sparse, graphical. Not a telemetry dump.
    Variants {
                ...
                RowLayout {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            Layout.preferredHeight: 32
                            radius: 9
                            color: root.stationActive(station) ? "#263540" : (stationArea.containsMouse ? root.elevated : "transparent")
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    color: root.stationActive(station) ? root.accentStrong : root.textMuted
                                }
                                Text {
                                    text: station
                                    color: root.stationActive(station) ? root.textMain : root.textMuted
                                    font.family: "Noto Sans"
                                    font.pixelSize: 13
                                    font.weight: root.stationActive(station) ? Font.DemiBold : Font.Medium
                                }
                            }
    ...
    // BOTTOM FLOATING DOCK: familiar app access with Dark Operator identity.
    Variants {
        model: Quickshell.screens
        PanelWindow {
            id: dockWindow
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                onClicked: {
                                    if (parent.entry) parent.entry.execute()
                                }
                            }
