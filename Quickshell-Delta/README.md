...
## Finalized design correction
- Top reveal remains the system-information bar.
- Bottom dock is a floating Apple-style dock: visible on the desktop and auto-hidden while applications are open, with bottom-edge reveal.
- Removed all hardcoded Chrome, Steam, Lutris, Heroic, Development-pod, and Gaming-pod shortcuts.
- Station/workspace floating surface starts empty. No default station shortcuts are invented by the shell.
- Gaming is not represented as a station shortcut pod.
