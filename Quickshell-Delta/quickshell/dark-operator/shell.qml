                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea { id: dockMouse; anchors.fill: parent; hoverEnabled: true; onClicked: modelData.name === "Google Chrome" ? root.launchBrowser() : root.focusOrLaunch(parent.entry, modelData.candidates) }
